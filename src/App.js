...
import movieStore from './data/movie';
import actorStore from './data/actor';
      ...
      return (
        <div className='relative'>
          ...
          <Switch>
            ...
            <Route
              path={`/director/${
                directorName ? directorName.split(' ').join('-') : directorName
              }`}
            >
              <Actor id={directorId} scrollTop={this.scrollTop} />
            </Route>
            {
              // Routes for Actors
            }
            {!loaded
              ...
              ? cast.slice(0, 11).map(person => (
                  ...
                  >
                    <Actor id={person.id} scrollTop={this.scrollTop} />
                  </Route>
                ))
              : null}
